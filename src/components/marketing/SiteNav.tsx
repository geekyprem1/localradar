    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
        ...
        <div className="hidden items-center gap-6 text-sm text-white/55 lg:flex">
          {links.map((l) => (
            <Link
              key={l.href}
              href={l.href}
              className="rounded transition-colors hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2DD4A7]"
            >
              {l.label}
            </Link>
          ))}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link
            href="/login"
            className="hidden rounded text-sm font-medium text-white/65 transition-colors hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2DD4A7] sm:block"
          >
            Sign in
          </Link>
          <Link
            href="/signup"
            className="rounded-full bg-[#2DD4A7] px-4 py-2 text-sm font-semibold text-[#04130E] transition-all hover:bg-[#3ee2b6] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2DD4A7] focus-visible:ring-offset-2 focus-visible:ring-offset-[#08090A]"
          >
            Start Free
          </Link>
          <button
