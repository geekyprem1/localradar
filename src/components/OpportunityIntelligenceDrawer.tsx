            ...
            <div>
              ...
              <div className="flex items-start justify-between border-b border-border pb-5">
                <div className="space-y-1.5 max-w-[85%]">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-[9px] font-normal text-foreground bg-border border border-border px-2 py-0.5 rounded font-mono uppercase tracking-wider">
                      Opportunity Intelligence Dossier
                    </span>
                    <span className="text-[9px] text-secondary-text bg-secondary-bg border border-border px-2 py-0.5 rounded font-mono uppercase font-normal">
                      {categoryName}
                    </span>
                  </div>
                  ...
                  <div className="text-[10px] text-secondary-text font-mono font-normal">
                    Generated by <span className="text-foreground font-semibold">LocalRadar Intelligence Engine™</span>
                  </div>
                  <div className="text-[9px] text-muted-text font-mono mt-0.5">
              ...
              <div className="grid grid-cols-3 gap-3 my-5 font-mono">
                <div className="p-3 bg-background border border-border rounded-xl relative">
                  <span className="text-[8px] font-normal text-muted-text uppercase tracking-widest block">Opportunity Engine™</span>
                  <div className="flex items-baseline gap-1.5 mt-2">
                    ...
                    <span className="text-[8px] text-muted-text font-normal">/100</span>
                  </div>
                ...
                <div className="p-3 bg-background border border-border rounded-xl">
                  <span className="text-[8px] font-normal text-muted-text uppercase tracking-widest block">Closing Probability™</span>
                  <div className="flex items-baseline gap-1 mt-2">
                    <span className="text-xl font-semibold text-primary">{scored.closingProbability}%</span>
                  </div>
                  <span className="text-[8px] text-muted-text block mt-0.5 font-normal">Velocity Target</span>
                </div>

                <div className="p-3 bg-background border border-border rounded-xl">
                  <span className="text-[8px] font-normal text-muted-text uppercase tracking-widest block">Revenue Potential™</span>
                  <div className="flex items-baseline gap-1 mt-2">
                    <span className="text-sm font-semibold text-foreground truncate max-w-full">
                      {formatCurrency(scored.dealValue.max)}
                    </span>
                  </div>
                  <span className="text-[8px] text-primary block mt-0.5 font-normal">Est. Margin Cap</span>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-background border border-border p-5 rounded-xl space-y-3 relative overflow-hidden">
                  {isFree && (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-bold text-foreground uppercase tracking-wider font-mono">Contact Discovery Locked</span>
                      <span className="text-[9px] text-muted-text mt-0.5">Upgrade to Pro to reveal business emails & pages</span>
                    </div>
                  )}
                ...
                <div className="bg-background border border-border p-5 rounded-xl space-y-3">
                  ...
                  <div className="flex items-center gap-6 font-mono">
                    ...
                    <div className="text-[10px] text-secondary-text space-y-1.5 flex-1 leading-normal">
                ...
                <div className="bg-background border border-border p-5 rounded-xl space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3 font-mono text-center">
                    <div className="p-2.5 bg-secondary-bg border border-border rounded-lg">
                      <span className="text-muted-text block text-[8px] uppercase tracking-widest mb-1 font-normal">Minimum Contract</span>
                      <span className="text-foreground font-semibold text-xs">{formatCurrency(scored.dealValue.min)}</span>
                    </div>

                    <div className="p-2.5 bg-secondary-bg border border-border rounded-lg">
                      <span className="text-muted-text block text-[8px] uppercase tracking-widest mb-1 font-normal">Maximum Contract</span>
                    ...
                    <div className="p-2.5 bg-primary/5 border border-primary/30 rounded-lg">
                      <span className="text-primary block text-[8px] uppercase tracking-widest mb-1 font-normal">Recommended Proposal</span>
                  ...
                  <div className="space-y-3 font-sans text-xs">
                    ...
                    <div className="space-y-1.5 font-normal">
                      ...
                      <button
                        ...
                        className="bg-secondary-bg hover:bg-[#22242a] border border-border text-foreground text-[10px] font-semibold px-3 py-1.5 rounded-lg transition-all flex items-center gap-1 ml-auto font-mono cursor-pointer"
                      >
