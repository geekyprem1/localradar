...
export default function WhyThisLead({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-24 h-24 bg-[#FAFAF9]/2 rounded-full blur-2xl pointer-events-none" />

      <div className="flex items-center justify-between text-xs font-mono uppercase tracking-wider text-[#A1A1AA] font-semibold mb-3.5">
        <div className="flex items-center gap-2">
          <Sparkles className="w-4 h-4 text-[#A1A1AA] animate-pulse" />
          Why This Lead™
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3.5 pt-3 border-t border-[#26282D] text-xs font-mono">
          <div>
            ...
            <span className="text-[#2DD4A7] font-semibold text-sm flex items-center gap-0.5">
              <DollarSign className="w-3.5 h-3.5 text-[#2DD4A7]" />
          ...
          <div>
            ...
            <span className="text-white font-semibold text-sm flex items-center gap-1">
              <Award className="w-3.5 h-3.5 text-[#A1A1AA]" />
              {recommendedService}
            </span>
          </div>
        </div>
